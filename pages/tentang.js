    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-blue-900 mb-4">Tentang Kami</h1>
          <div className="w-24 h-1 bg-blue-700 mx-auto"></div>
        </div>

        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-blue-800 mb-4">Sejarah Gereja</h2>
        ...
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-blue-800 mb-4">Visi & Misi</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-5 rounded-lg">
              <h3 className="text-xl font-semibold text-blue-700 mb-3">Visi</h3>
              <p className="text-gray-700">
        ...
        <Card className="mb-8">
          <h2 className="text-2xl font-semibold text-blue-800 mb-4">Pelayanan Kami</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-lg mb-2">Pelayanan Ibadah</h3>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-lg mb-2">Pelayanan Kaum Muda</h3>
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-center hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-lg mb-2">Pelayanan Sosial</h3>
